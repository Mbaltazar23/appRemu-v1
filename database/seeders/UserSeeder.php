...
class UserSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $permissionsContador = [
            "MANTRA", "REMEMI", "MANAFPTR", "CONPREVAFP", "MANBODESCOL", "MANBODESTRA", "CONPREVISAPRE", "MANIECO", "MANBODESGEN", "MANLIQ", "MANIMREN", "MANASIGFAM", "MANLIC", "MANAFP", "MANISAPRETR", "MANINAS", "PLANREMU", "MANICOM", "CERTREMU"
        ];
