    ...
    public function run(): void
    {
        ...
        $operations = [
            ...
            ['REBAJAIMPUESTO', 2,
                ...
                '', 0, 0, 0, '111111111111'],
            ['SEGUROCESANTIA',1,'FILTROCONTRATOINDEF / FILTROCONTRATOINDEF * 0.006 * RENTAIMPONIBLE M+ FILTROCONTRATOFIJO / FILTROCONTRATOFIJO * 0.03 * RENTAIMPONIBLE M+ MR','',0,0,0,'111111111111'],
            ['SEGUROCESANTIA', 2,
            ...
            ['ASIGNACIONFAMILIAR', 1,
                ...
                '', 0, 0, 0, '111111111111'],
            ['ASIGNACIONFAMILIAR',2,'FILTROASIGFAMT1 / FILTROASIGFAMT1 * ASIGCAR.FAMTRAMO1 M+ FILTROASIGFAMT2 / FILTROASIGFAMT2 * ASIGCAR.FAMTRAMO2 M+ FILTROASIGFAMT3 / FILTROASIGFAMT3 * ASIGCAR.FAMTRAMO3 M+ MR * CARGASFAMILIARES','',0,0,0,'111111111111'],
