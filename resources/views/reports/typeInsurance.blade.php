            ...
            <div class="container-xl">
                ...
                <div class="card mb-4" id="dateSelectionCard">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h3 class="mb-0">Informe Previsional -
                            {{ App\Models\Insurance::getInsuranceTypes()[$typeInsurance] }}</h3>
...
<script>
    function openPopup(event) {
        ...
        // Abrir la ventana emergente con la URL generada
        window.open(url, 'Informe Previsional', 'width=900,height=500');
    }
</script>
@endpush
